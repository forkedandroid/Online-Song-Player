...
import com.example.android.uamp.model.SoundColudMusicProvider;
import com.example.android.uamp.ui.NowPlayingActivity;
import com.example.android.uamp.utils.CarHelper;
import com.example.android.uamp.utils.LogHelper;
import com.example.android.uamp.utils.MediaIDHelper;

import com.example.android.uamp.utils.SoundCloudQueueHelper;
...
public class SoundCloudMusicService extends MediaBrowserService implements SoundCloudPlayback.Callback {
    ...
    private SoundColudMusicProvider mMusicProvider;
    private MediaSession mSession;
    // "Now playing" queue:
    private List<MediaSession.QueueItem> mPlayingQueue;
    private int mCurrentIndexOnQueue;
    private SoundCloudMediaNotificationManager mMediaNotificationManager;
    // Indicates whether the service was started.
    private boolean mServiceStarted;
    private Bundle mSessionExtras;
    private final DelayedStopHandler mDelayedStopHandler = new DelayedStopHandler(this);
    private SoundCloudPlayback mPlayback;
    ...
    private final VideoCastConsumerImpl mCastConsumer = new VideoCastConsumerImpl() {
        ...
        public void onApplicationConnected(ApplicationMetadata appMetadata, String sessionId,
            ...
            SoundCloudPlayback playback = new SoundColudCastPlayback(mMusicProvider);
        ...
        public void onDisconnected() {
            ...
            mSession.setExtras(mSessionExtras);
            SoundCloudPlayback playback = new SoundCloudLocalPlayback(SoundCloudMusicService.this, mMusicProvider);
    ...
    public void onCreate() {
        ...
        mMusicProvider = new SoundColudMusicProvider();
        mPackageValidator = new PackageValidator(this);

        // Start a new MediaSession
        mSession = new MediaSession(this, "SoundCloudMusicService");
        setSessionToken(mSession.getSessionToken());
        mSession.setCallback(new MediaSessionCallback());
        mSession.setFlags(MediaSession.FLAG_HANDLES_MEDIA_BUTTONS |
                MediaSession.FLAG_HANDLES_TRANSPORT_CONTROLS);

        mPlayback = new SoundCloudLocalPlayback(this, mMusicProvider);
        ...
        mMediaNotificationManager = new SoundCloudMediaNotificationManager(this);
    ...
    public void onLoadChildren(@NonNull final String parentMediaId,
        ...
        if (!mMusicProvider.isInitialized()) {
            ...
            mMusicProvider.retrieveMediaAsync(new SoundColudMusicProvider.Callback() {
                @Override
    ...
    private final class MediaSessionCallback extends MediaSession.Callback {
        ...
        public void onPlay() {
            ...
            if (mPlayingQueue == null || mPlayingQueue.isEmpty()) {
                mPlayingQueue = SoundCloudQueueHelper.getRandomQueue(mMusicProvider);
        ...
        public void onSkipToQueueItem(long queueId) {
            ...
            if (mPlayingQueue != null && !mPlayingQueue.isEmpty()) {
                ...
                mCurrentIndexOnQueue = SoundCloudQueueHelper.getMusicIndexOnQueue(mPlayingQueue, queueId);
                // play the music
                handlePlayRequest();
            }
        }
        ...
        public void onPlayFromMediaId(String mediaId, Bundle extras) {
            ...
            // selected from.
            mPlayingQueue = SoundCloudQueueHelper.getPlayingQueue(mediaId, mMusicProvider);
            mSession.setQueue(mPlayingQueue);
            ...
            if (mPlayingQueue != null && !mPlayingQueue.isEmpty()) {
                ...
                mCurrentIndexOnQueue = SoundCloudQueueHelper.getMusicIndexOnQueue(mPlayingQueue, mediaId);
        ...
        public void onSkipToNext() {
            ...
            if (SoundCloudQueueHelper.isIndexPlayable(mCurrentIndexOnQueue, mPlayingQueue)) {
                handlePlayRequest();
            } else {
        ...
        public void onPlayFromSearch(final String query, final Bundle extras) {
            ...
            mMusicProvider.retrieveMediaAsync(new SoundColudMusicProvider.Callback() {
                @Override
                public void onMusicCatalogReady(boolean success) {
                    mPlayingQueue = SoundCloudQueueHelper.getPlayingQueueFromSearch(query, extras,
                            mMusicProvider);
    ...
    public void onMetadataChanged(String mediaId) {
        ...
        List<MediaSession.QueueItem> queue = SoundCloudQueueHelper.getPlayingQueue(mediaId, mMusicProvider);
        int index = SoundCloudQueueHelper.getMusicIndexOnQueue(queue, mediaId);
        if (index > -1) {
     ...
     */
    private void switchToPlayer(SoundCloudPlayback playback, boolean resumePlaying) {
        if (playback == null) {
        ...
        switch (oldState) {
            ...
            case PlaybackState.STATE_PLAYING:
                if (resumePlaying && SoundCloudQueueHelper.isIndexPlayable(mCurrentIndexOnQueue, mPlayingQueue)) {
                    mPlayback.play(mPlayingQueue.get(mCurrentIndexOnQueue));
    ...
    private static class DelayedStopHandler extends Handler {
        private final WeakReference<SoundCloudMusicService> mWeakReference;

        private DelayedStopHandler(SoundCloudMusicService service) {
            mWeakReference = new WeakReference<>(service);
        }

        @Override
        public void handleMessage(Message msg) {
            SoundCloudMusicService service = mWeakReference.get();
