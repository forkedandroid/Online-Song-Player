...
public class MeDownlServer extends MeDownl{
	
	Context mContext;
	
	
	public MeDownlServer(URL url, String outputFolder, int numConnections,String filename,Context context) {
		super(url, outputFolder, numConnections,filename,context);
		mContext = context;
