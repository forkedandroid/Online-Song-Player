...
import com.example.android.uamp.save.ActFileDownloader;
...
public abstract class ActionBarCastActivity extends AppCompatActivity {
            ...
            if (mItemToOpenWhenDrawerCloses >= 0) {
                ...
                switch (mItemToOpenWhenDrawerCloses) {
                    ...
                    case R.id.navigation_search:
                        activityClass = SoundCloudMusicPlayerActivity.class;
                        break;

                    case R.id.navigation_playlists:
                        activityClass = ActFileDownloader.class; //PlaceholderActivity.class
                        break;
                    case R.id.navigation_share:
                        activityClass = ShareActivity.class;
                        break;
                }
    ...
    private void populateDrawerItems(NavigationView navigationView) {
        ...
        else if (SoundCloudMusicPlayerActivity.class.isAssignableFrom(getClass())) {
        ...
        else if (ShareActivity.class.isAssignableFrom(getClass())) {
            navigationView.setCheckedItem(R.id.navigation_share);
        }
    }
