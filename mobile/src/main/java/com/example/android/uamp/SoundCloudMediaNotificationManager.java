...
public class SoundCloudMediaNotificationManager extends BroadcastReceiver {
    private static final String TAG = LogHelper.makeLogTag(SoundCloudMediaNotificationManager.class);
    ...
    private final SoundCloudMusicService mService;
    ...
    public SoundCloudMediaNotificationManager(SoundCloudMusicService service) {
        mService = service;
        updateSessionToken();
